...
def add_users():
    with SessionLocal() as session:
        users = [
            User(username="tim_doe", email="tim@example.com", password="password123"),
            User(username="anya_doe", email="anya@example.com", password="securepassword"),
            User(username="ava", email="ava@example.com", password="mypassword"),
        ]
...
def add_posts():
    with SessionLocal() as session:
        ...
        posts = [
            Post(title="First Post", content="This is the 1th post", user_id=users[0].id),
            Post(title="Second Post", content="Salam world!", user_id=users[1].id),
